...
2. **Installation**:
   ...
   - On Linux/MacOS:
     ...
     ```sh
     bash <(curl -s https://raw.githubusercontent.com/stormZhu/nvim-nvchad/main/installer/install.sh)
     ```

   - On Windows (Powershell):
     ```ps1
     Invoke-WebRequest https://raw.githubusercontent.com/stormZhu/nvim-nvchad/main/installer/install.ps1 -UseBasicParsing | Invoke-Expression
     ```
